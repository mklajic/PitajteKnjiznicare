    ...
    <div class="large-12 columns">
      <div class="row collapse">
        ...
        <div class="small-1 columns">
			...
			<div class="row">
					<div class="large-12 columns">
					<a href="dodaj.php?sifra=<?php echo $o->sifra; ?>" class=" button small expand">Dodaj novi studij</a>
			</div>
			</div>
...
<table>
  ...
  <tbody>
	...
	$stranica = 1;
			...
			$izraz=$veza-> prepare("select * from studij where concat(sifra, ' ',naziv) like :uvjet limit " . (($stranica * 10)-10) . ",10");
