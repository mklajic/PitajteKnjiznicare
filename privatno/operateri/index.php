    ...
    <div class="large-12 columns">
      <div class="row collapse">
        ...
        <div class="small-1 columns">
			...
			<div class="row">
					<div class="large-12 columns">
					<a href="dodaj.php?sifra=<?php echo $o->sifra; ?>" class=" button small expand dug">Dodaj novog operatera</a>
			</div>
			</div>
			<div class="row">
				<div class="large-12 columns">
...
<table>
  <thead>
    <tr>
    	...
    	<th width="200">Ime</th>
    	<th width="250">Prezime</th>
    	<th width="210">Email</th>
    	<th width="100">Uloga</th>
      <th width="50"></th>
      <th width="50"></th>
    </tr>
  </thead>
  <tbody>
	...
	$stranica = 1;
			...
			$izraz=$veza-> prepare("select a.sifra as sifra, a.ime as ime, a.prezime as prezime, a.email as email, b.naziv as uloga from operater a inner join uloga b on a.uloga=b.sifra where concat(ime, ' ',prezime, ' ',email) like :uvjet limit " . (($stranica * 10)-10) . ",10");
