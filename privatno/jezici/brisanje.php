...
if($_POST){
	...
	$izraz  =$veza->prepare("delete from jezik where sifra=:sifra");
	$izraz->execute($_POST);
...
$izraz=$veza-> prepare("select * from jezik where sifra=:sifra");
  ...
  <body>
	...
	<div class="row">
		...
		<div class="large-6 push-3 columns">
			...
			<h5 align="center"> Jeste li sigurni da želite obrisati jezik: </br> 
		<?php echo $o->naziv ?> </h5> 
