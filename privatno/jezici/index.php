    ...
    <div class="large-12 columns">
      <div class="row collapse">
        ...
        <div class="small-1 columns">
			...
			<div class="row">
					<div class="large-12 columns">
					<a href="dodaj.php?sifra=<?php echo $o->sifra; ?>" class=" button small expand">Dodaj novi jezik</a>
					</div>
			</div>
			<div class="row">
			<div class="large-12 columns">
...
<table>
  ...
  <tbody>
			...
			$izraz=$veza-> prepare("select * from jezik where concat(sifra, ' ',naziv) like :uvjet limit " . (($stranica * 10)-10) . ",10");
