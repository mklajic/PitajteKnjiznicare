...
<table>
  ...
  <tbody>
	...
	$stranica = 1;
			...
			$izraz=$veza-> prepare("select * from upit where concat(sifra, ' ',pitanje) like :uvjet group by sifra desc limit " . (($stranica * 10)-10) . ",10");
			...
			foreach($rezultati as $o){
				...
				<td>	<a href="promjena.php?sifra=<?php echo $o->sifra; ?>"> <img src="../../img/settings18.png" alt="" align="center" />  </a> <br/> </td>
