...
<div class="large-12 columns">
 <ul class="breadcrumbs">
  ...
  <li><a href="odgovoreniUpiti.php"> <b>Odgovoreni upiti </b> </a></li>
	...
	$stranica = 1;
		...
		$uvjet = $_POST["uvjet"];
			...
			$izraz=$veza-> prepare("select a.sifra as sifra, d.ime, d.prezime, d.email,
				...
				where (odgovor is not null and concat(a.sifra, ' ',a.pitanje) like :uvjet) 
				order by a.sifra desc limit " . (($stranica * 10)-10) . ",10");
...
<div class="row">
				<div class="pagination-centered">
					<ul class="pagination">
						<li class="arrow">
					<a href="odgovoreniUpiti.php?stranica=<?php
