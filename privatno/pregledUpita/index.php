...
<ul class="breadcrumbs">
  <li><b><a href="index.php"><b> Neodgovoreni upiti </b> </a></b></li>
  <li><a href="odgovoreniUpiti.php"> Odgovoreni upiti </a></li>
  <li><a href="sviUpiti.php"> Svi upiti </a></li>
</ul>	
</div>
</div>	
	...
	$stranica = 1;
		...
		$uvjet = $_POST["uvjet"];
			...
			$izraz=$veza-> prepare("select a.sifra as sifra, d.ime, d.prezime, d.email,
				...
				where (odgovor is null and concat(a.sifra, ' ',a.pitanje) like :uvjet) order by a.sifra limit " . (($stranica * 10)-10) . ",10");
  ...
  <tbody>
	<?php	
			...
			foreach($rezultati as $o){
				...
				<td><a title="Odgovori" href="promjena.php?sifra=<?php echo $o->sifra; ?>"> <img src="../../img/edit26.png" /> </a> </td>
				
				<td> <a title="Promijeni područje" href="promjenaPodrucja.php?sifra=<?php echo $o->sifra; ?>">	<img src="../../img/settings18.png" /> </a> </td>
				</tr>
